...
def check_map_parameters(pool_params: WorkerPoolParams, iterable_of_args: Union[Sized, Iterable],
                         ...
                         progress_bar_options: Optional[Dict[str, Any]], progress_bar_backend: Optional[str],
    ...
    :param progress_bar_backend: Backend to use for the progress bar
...
def check_progress_bar_options(progress_bar_options: Optional[Dict[str, Any]], progress_bar_position: Optional[int],
                               n_tasks: Optional[int], progress_bar_backend: Optional[str]) -> Dict[str, Any]:
    """
    ...
    :param progress_bar_backend: Progress bar backend to use
    ...
    # Get the tqdm progress bar backend. This will also check that the backend is valid
    get_tqdm(progress_bar_backend)
