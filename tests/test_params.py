...
# from mpire.params import check_map_parameters, WorkerTaskParams, WorkerPoolParams, get_number_of_tasks, check_number, \
...
#         Test equality
#         """
#         params = WorkerTaskParams(lambda x: x, None, None, None, False, None, None, None)
...
#                     [None, 37],
#             ):
#                 self.assertNotEqual(params, WorkerTaskParams(func, worker_init, worker_exit, worker_lifespan,
#                                                             progress_bar, task_timeout, worker_init_timeout,
#                                                             worker_exit_timeout))

#         params = WorkerTaskParams(self._f1, self._init1, self._exit1, 42, True, 1, 2, 3)

#         with self.subTest('initialized and nothing changed'):
#             self.assertEqual(params, WorkerTaskParams(self._f1, self._init1, self._exit1, 42, True, 1, 2, 3))

#         with self.subTest('initialized and a parameter changed'), warnings.catch_warnings():
#             warnings.simplefilter("ignore")
#             self.assertNotEqual(params, WorkerTaskParams(self._f2, self._init1, self._exit1, 42, True, 1, 2, 3))
#             self.assertNotEqual(params, WorkerTaskParams(self._f1, self._init2, self._exit1, 42, True, 1, 2, 3))
#             self.assertNotEqual(params, WorkerTaskParams(self._f1, self._init1, self._exit2, 42, True, 1, 2, 3))
#             self.assertNotEqual(params, WorkerTaskParams(self._f1, self._init1, self._exit1, 1337, True, 1, 2, 3))
#             self.assertNotEqual(params, WorkerTaskParams(self._f1, self._init1, self._exit1, 42, False, 1, 2, 3))
#             self.assertNotEqual(params, WorkerTaskParams(self._f1, self._init1, self._exit1, 42, True, 2, 2, 3))
#             self.assertNotEqual(params, WorkerTaskParams(self._f1, self._init1, self._exit1, 42, True, 1, 3, 3))
#             self.assertNotEqual(params, WorkerTaskParams(self._f1, self._init1, self._exit1, 42, True, 1, 2, 4))
